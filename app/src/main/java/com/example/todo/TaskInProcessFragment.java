...
public class TaskInProcessFragment extends Fragment implements DialogDismissListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        taskAdapter = new TaskAdapter(getActivity(), getActivity().getSupportFragmentManager(), "in process", folderName);
